...
| :--- | :--- | :--- |
| `📂 Lectures` | Slide Decks | Conceptual frameworks and business case studies. |
| `📂 Tutorials` | Step-by-step Guides | Hand-holding guides for building AI prototypes. |
| `📂 Resources` | Toolkits & Links | Recommended low-code platforms and AI API documentation. |
| `📂 Templates` | Project Scaffolding | Ready-to-use templates for business requirements and technical specs. |
...
**Copyright © 2026 CUHK Business School.** *While the materials are open-sourced under the MIT agreement, the branding, logos, and institutional identity remain the exclusive property of the Chinese University of Hong Kong (CUHK) Business School.*
